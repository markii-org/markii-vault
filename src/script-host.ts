 ...
 * `api.github.com` (a demo REST call) and `api.open-meteo.com` (the weather
 * note). This mirrors what a real host does with its SSRF policy surface
 * (docs/scripting.md §10): explicit per-host grants, never wildcards.
 */
